...
void getParameter(InitParam& params){
    ...
    params.SorVoxLeafSize = getParam<float>(yamlNodeObj,"SorVoxLeafSize",params.SorVoxLeafSize);
    params.ThresholdIntensity = getParam<float>(yamlNodeObj,"ThresholdIntensity",params.ThresholdIntensity);
    params.ErrrorPointSearchRadius = getParam<float>(yamlNodeObj,"ErrrorPointSearchRadius",params.ErrrorPointSearchRadius);
    params.ErrrorPointNearNum = getParam<float>(yamlNodeObj,"ErrrorPointNearNum",params.ErrrorPointNearNum);
    params.StdTargetSize = getParam<float>(yamlNodeObj,"StdTargetSize",params.StdTargetSize);
    ...
    params.GridmapNum_x = getParam<float>(yamlNodeObj,"GridmapNum_x",params.GridmapNum_x);
    params.GridmapNum_y = getParam<float>(yamlNodeObj,"GridmapNum_y",params.GridmapNum_y);
    params.GridScale = getParam<float>(yamlNodeObj,"GridScale",params.GridScale);
    params.PixelPerGrid = getParam<float>(yamlNodeObj,"PixelPerGrid",params.PixelPerGrid);
    ...
    params.GroundEstimateNum = getParam<float>(yamlNodeObj,"GroundEstimateNum",params.GroundEstimateNum);
    params.OutPlaneDistance = getParam<float>(yamlNodeObj,"OutPlaneDistance",params.OutPlaneDistance);
    ...
    params.MaxDeviaAngle_deg = getParam<float>(yamlNodeObj,"MaxDeviaAngle_deg",params.MaxDeviaAngle_deg);
}
