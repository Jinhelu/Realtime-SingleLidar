...
// 显示图像
void VisualTool::imShowCVMat(const std::string s, cv::Mat& CVMat){
    cv::imshow(s, CVMat);
}
...
// 显示起点和终点图像
void VisualTool::pointShow(int flag, int x, int y, int delta, const cv::Mat& mapImage, const std::string ImageName){
